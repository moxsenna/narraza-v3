...
import { resolveProjectWritingContext, type ProjectContextDependencies } from './project-context';

const project = (title: string) => ({ title });
const chapter = (title: string, ordinal: number | null, extra: Record<string, unknown> = {}) => ({
