...
export default function GlobalError({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center overflow-x-clip bg-canvas px-4 py-12 text-center text-primary">
      <BrandMark href="/" />
      ...
      <p className="mt-4 max-w-md leading-7 text-secondary">{copy.description}</p>
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        ...
        <Link
          href="/"
          className="inline-flex min-h-11 items-center rounded-md border border-default bg-surface px-6 font-semibold text-brand-strong hover:border-active hover:bg-brand-soft"
        >
