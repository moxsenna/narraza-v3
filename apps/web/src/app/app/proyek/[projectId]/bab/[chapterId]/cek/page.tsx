  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
      <header className="mb-8 border-b border-border-default pb-4">
        <p className="text-xs font-extrabold tracking-[0.14em] text-text-muted">CEK BAB</p>
      ...
      <section className="rounded-2xl border border-border-default bg-surface p-6 sm:p-8">
        <h2 className="mb-4 text-xl font-semibold text-text-primary">Status Validasi</h2>
        <div className="space-y-4">
          <p className="text-base leading-7 text-text-secondary">
            Proses verifikasi naskah akan menampilkan temuan validasi di sini ketika kemampuan aktif
            tersedia.
          </p>
