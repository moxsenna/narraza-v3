        ...
        >
          ...
          <fieldset className="space-y-2">
            ...
            {JALUR.map((j) => (
              <label
                key={j.value}
                className="flex min-h-11 items-center gap-3 rounded-xl border border-gray-200 px-3 py-2"
              >
                <input
                  type="radio"
                  name="jalur"
            ...
            <label className="flex min-h-11 cursor-not-allowed items-center gap-3 rounded-xl border border-gray-200 px-3 py-2 opacity-50">
