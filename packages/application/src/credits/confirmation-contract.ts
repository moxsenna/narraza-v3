...
export type ConfirmQuoteResult =
  | { readonly kind: 'confirmed'; readonly reservation: CreditReservationRecord; readonly job: GenerationJobRecord }
  | { readonly kind: 'exact_replay'; readonly reservation: CreditReservationRecord; readonly job: GenerationJobRecord }
